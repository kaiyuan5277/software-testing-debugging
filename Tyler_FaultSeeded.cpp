 ...
 *************************************************************************/
string stringInputCheck(string phrase, int size)
{
...
void readDataFile(string filename, bool opened)
{
    ...
    if(dataFile.good) //If file opened, read the data line by line
    {
        int lineCount=1;
...
void printAllStudents(vector<Student> studentData)
{
    ...
    for(int i=0; i<=studentData.size(); i++)
    {
        cout<<" "<<left<<setw(40)<<studentData[i].name<<setw(18)<<studentData[i].USF_ID<<setw(40)<<studentData[i].email<<setw(22)<<
            ((studentData[i].presGrade==-1)?'-':studentData[i].presGrade+48)<<setw(22)<<
            ((studentData[i].essayGrade==-1)?'-':studentData[i].essayGrade+48)<<setw(22)<<
            ((studentData[i].projectGrade==-1)?'-':studentData[i].projectGrade+48)<<endl;
    }   
    cout<<endl;
}
...
void printOneStudent(int index, vector<Student> studentVector)
{
    ...
    cout<<setw(28)<<"|Presentation Grade:"<<((studentVector[index].presGrade==-1)?'-':studentVector[index].presGrade+48)<<endl;
    cout<<setw(28)<<"|Essay Grade:"<<((studentVector[index].essayGrade==-1)?'-':studentVector[index].essayGrade+48)<<endl;
    cout<<setw(28)<<"|Project Grade:"<<((studentVector[index].projectGrade==-1)?'-':studentVector[index].projectGrade+48)<<endl;
    cout<<"---------------------------------------------------\n\n";
}